...
Uint32 mythVirtualDecoder::TimerCallback(Uint32 interval){
	...
	//printf("%d k/s\n", ret_count);
	return interval;//calc some XXXkb/s
}
...
int mythVirtualDecoder::GetFrameAsync(PacketQueue* packet)
{
	return 0;
}

int mythVirtualDecoder::StartAsync()
{
	return 0;
}

int mythVirtualDecoder::GetFrameBlock(PacketQueue* packet)
{
	return 0;
}
